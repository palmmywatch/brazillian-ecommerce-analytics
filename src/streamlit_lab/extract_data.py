...
DATASET_NAME = {
    ...
    , 'product_category_name_translation':  'name_translation'
...
def extract_data(data_utils_config: dict) -> dict[str, pd.DataFrame]:
    ...
    for file_path in existing_files:
        dataset_name = DATASET_NAME[file_path.stem]
